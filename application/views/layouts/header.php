...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/data-table/css/dataTables.bootstrap4.min.css'); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/data-table/css/buttons.dataTables.min.css'); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/data-table/css/responsive.bootstrap4.min.css'); ?>">
            ...
            <nav class="navbar header-navbar pcoded-header">
                <div class="navbar-wrapper">
                    ...
                    <div class="navbar-logo">
                        ...
                        <a href="<?php echo base_url('dashboard'); ?>" class="logo-cnt">
